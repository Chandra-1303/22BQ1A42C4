...
export const toast = {
  success: (message: string, duration?: number) => {
    if ((window as any).showToast) {
      (window as any).showToast({ message, type: 'success', duration });
    }
  },
  error: (message: string, duration?: number) => {
    if ((window as any).showToast) {
      (window as any).showToast({ message, type: 'error', duration });
    }
  },
  warning: (message: string, duration?: number) => {
    if ((window as any).showToast) {
      (window as any).showToast({ message, type: 'warning', duration });
    }
  },
  info: (message: string, duration?: number) => {
    if ((window as any).showToast) {
      (window as any).showToast({ message, type: 'info', duration });
    }
  },
};
